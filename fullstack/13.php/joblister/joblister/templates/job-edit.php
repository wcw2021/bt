...
<div class="container mt-4">
	<h2 class="text-primary mb-4">Edit Job Listing</h2>
	<form method="post" action="edit.php?id=<?php echo $job->id; ?>">
		...
		<div class="mt-4">
			<input type="submit" class="btn btn-secondary mr-2" value="Submit" name="submit">
	    <a class="btn btn-warning" href="job.php?id=<?php echo $job->id; ?>">Cancel</a>
		</div>
	</form>
</div>
